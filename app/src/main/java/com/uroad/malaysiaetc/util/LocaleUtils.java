...
public class LocaleUtils {
     ...
     * 马来西亚文
     */
    public static final Locale LOCALE_MALAYSIA = new Locale("ms");
    /**
     ...
     * @return true / false
     */
    public static boolean updateLocale(Context pContext, Locale pNewUserLocale) {
